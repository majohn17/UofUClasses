 ...
 * 
 * @author Erin Parker, Isaac Gibson, and Matthew Johsen
 * @version March 4, 2019
 */
public class GraphUtility {

	public static <Type> boolean isCyclic(List<Type> sources, List<Type> destinations) throws IllegalArgumentException {
		Graph<Type> data = generateGraph(sources, destinations);
		return data.isCyclic();
	}

	public static <Type> boolean areConnected(List<Type> sources, List<Type> destinations, Type srcData, Type dstData)
			throws IllegalArgumentException {
		Graph<Type> data = generateGraph(sources, destinations);
		return data.areConnected(srcData, dstData);
	}
	...
	/**
	 * Creates a graph from a source and destination list
	 */
	public static <Type> Graph<Type> generateGraph(List<Type> sources, List<Type> destinations)
		...
		Graph<Type> data = new Graph<Type>();
		for (int i = 0; i < sources.size(); i++) {
			data.addEdge(sources.get(i), destinations.get(i));
		}
		return data;
	}
