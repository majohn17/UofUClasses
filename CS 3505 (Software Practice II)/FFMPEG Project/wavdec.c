...
static int wav_read_header(AVFormatContext *s)
{
    ...
    av_log(NULL, AV_LOG_INFO, "*** CS 3505 Spring 2020:  Running code in wavdec.c in function wave_read_header ***\n"
        "*** CS 3505 Spring 2020:  Changed by Matthew Johnsen and Isaac Gibson ***\n");
