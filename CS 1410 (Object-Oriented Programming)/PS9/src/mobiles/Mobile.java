 ...
 * hanging from itsx right end. The rod is hanging from a vertical wire. The distance along the rod from the vertical
...
public class Mobile
{
    ...
    public int weight ()
    {
        ...
        {
            int totalWeight = 0;
            totalWeight = totalWeight + left.weight();
            totalWeight = totalWeight + right.weight();
            return totalWeight;
        }
    }
    ...
    public boolean isBalanced ()
    {
        ...
        else
        {
            ...
            if (this.leftLength * left.weight() == this.rightLength * right.weight())
            {
                temp = true;
            }
            if (left.isBalanced() && right.isBalanced() && temp)
            {
                return true;
            }
    ...
    public int bobCount ()
    {
        ...
        {
            int bobNumber = 0;
            bobNumber = bobNumber + left.bobCount();
            bobNumber = bobNumber + right.bobCount();
            return bobNumber;
        }
    }
    ...
    public int longestRod ()
    {
        ...
        {
            int longRod = this.leftLength + this.rightLength;
            int combineRod = Math.max(left.longestRod(), right.longestRod());
            return Math.max(longRod, combineRod);
        }
    }
